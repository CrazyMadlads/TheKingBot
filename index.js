...
const ayyimg = new Discord.MessageEmbed()
...
client.on('message', msg => {
  ...
  if (msg.content === 'ping') {
    ...
    if (msg.content.indexOf('ayy') >= 0 || msg.content.indexOf('Ayy') >= 0) {
        var lmaos = ['ayy lmao! :alien:', 'remember the ayylmao! :alien: :face_with_cowboy_hat:', ('Your new name is ' + "@" + msg.author.username + 'ayy Lmao! :alien:'), channel.send(ayyimg)];
